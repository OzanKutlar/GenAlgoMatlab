...
%
% INPUT:
% 'p1' is the chromosome of the first parent
% 'p2' is the chromosome of the second parent
%
% OUTPUT:
% 'o1' is the chromosome of the first child
% 'o2' is the chromosome of the second child
