...
global bbbcs;
    ...
    [FrontNo,MaxFNo] = NDSort(Population(:, bbbcs.n_variables + 1:bbbcs.n_variables + bbbcs.numberOfObjectives),N);
    Next = FrontNo < MaxFNo;
    
    %% Select the solutions in the last front
    Last   = find(FrontNo==MaxFNo);
    Choose = LastSelection(Population(Next, bbbcs.n_variables + 1:bbbcs.n_variables + bbbcs.numberOfObjectives),Population(Last, bbbcs.n_variables + 1:bbbcs.n_variables + bbbcs.numberOfObjectives),N-sum(Next),Z,Zmin);
