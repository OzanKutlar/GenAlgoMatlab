...
if size(fit_array_archive,1) ==  bbbcs.N
    return;

elseif size(fit_array_archive,1) <  bbbcs.N
    %fill fit_array_archive with dominated solutions
    n_dominated =  bbbcs.N - size(fit_array_archive,1);
    ...
    while size(fit_array_archive,1) >  bbbcs.N
